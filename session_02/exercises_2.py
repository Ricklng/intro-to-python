...
# temp2 = int(input("What is the temperature? "))
# temp3 = int(input("What is the temperature? "))
# temp4 = int(input("What is the temperature? "))
# temp5 = int(input("What is the temperature? "))
